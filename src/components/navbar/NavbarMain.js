import {
  ...
  export default function NavbarMain() {
    ...
    const backgroundMenuLists = useColorModeValue('rgb(255, 255, 255)', 'rgb(26, 32, 44)');
    const backgroundBoxShadow = useColorModeValue('2px 4px 6px 2px rgba(160, 174, 192, 0.6)',
