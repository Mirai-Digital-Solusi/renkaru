...
export default function Features() {
  ...
  return (
    <Container maxW="6xl" p={{ base: 5, md: 5 }} mt={{ md: '3em' }}>
        ...
        <Tag size='lg' variant='solid' colorScheme='teal' borderRadius='full' marginInline="auto">Our Services</Tag>
</Center>
        
      <chakra.h3 fontSize="4xl" fontWeight="bold" mb={20} textAlign="center">
        We Have Everything You Need
      </chakra.h3>
      <SimpleGrid columns={{ base: 1, sm: 1, md: 3 }} placeItems="center" spacing={10} mb={4}>
